...
class Cust_Win:
    def __init__(self,root):
        ...
        lbl_cust_ref.grid(row=0,column=0,sticky=W)  #-->sticky=W parameter indicates that the label should stick to the left side of its cell.
        ...
        if self.var_cust_mobile.get()=="" or self.var_cust_mother.get()=="":
            ...
            try:
                ...
                my_cursor.execute("insert into customer values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(self.var_ref.get(),
                                                                                                self.var_cust_name.get(),self.var_cust_mother.get(),
                                                                                                self.var_cust_gender.get(),self.var_cust_post.get(),
                                                                                                self.var_cust_mobile.get(),self.var_cust_email.get(), self.var_cust_nationality.get(),self.var_cust_id_proof.get(),self.var_cust_id_number.get(),
